      ...
      <div className="relative z-10 w-full section-padding pt-24 pb-12">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-6 animate-fade-in">
            ...
            <span className="text-white/80 font-sans text-sm tracking-wider uppercase">
              Clarksville, TN & Fort Campbell, KY
            </span>
          </div>

          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-beige leading-[1.1] mb-6 animate-fade-in-up">
            Find Your Home
            <br />
            <span className="text-green">Near Fort Campbell</span>
          </h1>

          <p className="font-sans text-base sm:text-lg text-white/80 max-w-xl mx-auto mb-4 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
